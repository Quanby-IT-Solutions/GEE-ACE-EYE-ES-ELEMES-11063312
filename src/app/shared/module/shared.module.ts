...
import { TestScoresComponent } from 'src/app/shared/components/classroom/test-scores/test-scores.component'; // Adjust the path as necessary

@NgModule({
  declarations: [
    TestScoresComponent, // Add the TestScoresComponent here
  ...
  exports: [
    ...
    StudentSettingTabModule,
    StudentSidebarModule,
    TestScoresComponent, // Add TestScoresComponent to exports
  ],
