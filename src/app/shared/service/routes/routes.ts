...
// end student-information
  ...
  public static get online_tasks(): string {
    return this.users_dashboard + '/online-tasks';
  }

  public static get test_scores(): string {
    return this.users_dashboard + '/test-scores';
  }

  public static get pre_enlistment  (): string {
    return this.users_dashboard + '/pre-enlistment';
  }

  public static get add_enroll(): string {
  ...
  public static get online_payment(): string {
    return this.users_dashboard + '/online-payment';
  }

  public static get express_payment(): string {
    return this.users_dashboard + '/express-payment';
  }

  // report

  public static get class_absences(): string {
    return this.users_dashboard + '/class-absences';
  }


  public static get term_grades(): string {
    return this.users_dashboard + '/term-grades';
  }


  public static get final_grades(): string {
    return this.users_dashboard + '/final-grades';
  }


  public static get gwa(): string {
    return this.users_dashboard + '/gwa';
  }
  ...
  public static get statement_accounts(): string {
    return this.users_dashboard + '/statement-accounts';
  }


  public static get in_out_monitoring(): string {
    return this.users_dashboard + '/in-out-monitoring';
  }


  public static get purchases_report(): string {
    return this.users_dashboard + '/purchases-report';
  }
  ...
  public static get subject_resources(): string {
    return this.users_dashboard + '/subject-resources';
  }

  public static get tests(): string {
    return this.users_dashboard + '/teacher-tests';
  }

  public static get test_bank(): string {
    return this.users_dashboard + '/test-bank';
  }

  public static get subject_modules(): string {
    return this.users_dashboard + '/subject-modules';
  }

  public static get class_modules(): string {
    return this.users_dashboard + '/class-modules';
  }

  public static get class_list(): string {
    return this.users_dashboard + '/class-list';
  }

  public static get teacher_online_tasks(): string {
    return this.users_dashboard + '/online-tasks';
  }

  public static get schedule_online_tasks(): string {
    return this.users_dashboard + '/schedule-online-tasks';
  }

  public static get check_online_tasks(): string {
    return this.users_dashboard + '/check-online-tasks';
  }
  ...
  public static get grading_sheet(): string {
    return this.users_dashboard + '/grading-sheet';
  }

  public static get class_attendance(): string {
    return this.users_dashboard + '/class-attendance';
  }

  public static get section_attendance(): string {
    return this.users_dashboard + '/section-attendance';
  }

  public static get override_attendance(): string {
    return this.users_dashboard + '/override-attendance';
  }

  public static get request_change_grade(): string {
    return this.users_dashboard + '/request-change-grade';
  }

  public static get adviser_comments(): string {
    return this.users_dashboard + '/adviser-comments';
  }
  ...
  public static get teacher_class_absences(): string {
    return this.users_dashboard + '/teacher-class-absences';
  }

  public static get test_item_analysis(): string {
    return this.users_dashboard + '/test-item-analysis';
  }

  public static get report_card(): string {
    return this.users_dashboard + '/report-card';
  }

  public static get permanent_record(): string {
    return this.users_dashboard + '/permanent-record';
  }

  public static get periodic_grades_listing(): string {
    return this.users_dashboard + '/periodic-grades-listing';
  }
...
public static get report_generation(): string {
  ...
  public static get forums(): string {
    return this.users_dashboard + '/forums';
  }
  ...
  public static get course_modules(): string {
    return this.courses + '/details/modules';
  }

  public static get course_ytLink(): string {
    return this.courses + '/details/modules/ytLink';
  }
  ...
  public static get login_enrollment(): string {
    return this.baseUrl + 'enrollment/login-enrollment';
  }
  ...
  public static get student_data(): string {
    return this.users_dashboard + '/enrollments/student-list/student-data';
  }
