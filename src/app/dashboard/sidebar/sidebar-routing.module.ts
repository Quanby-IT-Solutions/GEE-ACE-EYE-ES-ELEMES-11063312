...
const routes: Routes = [
  {
    ...
    children: [
...

      {
        path: 'assessments',
        loadChildren: () =>
          import('src/app/dashboard/users/student_information/assessments/assessments.module').then(
...

      {
        ...
        loadChildren: () =>
          import(
            'src/app/dashboard/users/meet/meet.module'
          ).then((m) => m.MeetModule),
      },

      {
        path: 'attendance',
        loadChildren: () =>
          import('src/app/dashboard/users/student_information/attendance/attendance.module').then(
...

      {
        path: 'clearance',
        loadChildren: () =>
          import('src/app/dashboard/users/student_information/clearance/clearance.module').then(
            (m) => m.ClearanceModule
          ),
      },

      {
        ...
        loadChildren: () =>
          import('src/app/dashboard/users/student_information/document-management/document-management.module').then(
...

      {
        path: 'kiosk',
        loadChildren: () =>
          import('src/app/dashboard/users/student_information/kiosk/kiosk.module').then(
            (m) => m.KioskModule
          ),
      },

      {
        path: 'queuing',
        loadChildren: () =>
          import('src/app/dashboard/users/student_information/queuing/queuing.module').then(
            (m) => m.QueuingModule
          ),
      },

      {
        path: 'schedules',
        loadChildren: () =>
          import('src/app/dashboard/users/student_information/schedules/schedules.module').then(
            (m) => m.SchedulesModule
          ),
      },

      {
        path: 'scholarships',
        loadChildren: () =>
          import('src/app/dashboard/users/student_information/scholarships/scholarships.module').then(
...

      {
        path: 'class-records',
        loadChildren: () =>
          import('src/app/dashboard/users/grading-system/class-records/class-records.module').then(
...

      {
        ...
        loadChildren: () =>
          import('src/app/dashboard/users/grading-system/report-generation/report-generation.module').then(
...

      {
        path: 'notification',
        loadChildren: () =>
          import('src/app/dashboard/users/notification/notification.module').then(
      ...
      },
      {
        ...
        loadChildren: () =>
          import('src/app/dashboard/admin/settings/themes/themes.module').then(
            (m) => m.ThemesModule
          ),
      },
      {
