...
sample
    ...
    ``bash         ng generate component modules/home     ``
...
Uses supabase [DB](https://supabase.com/dashboard/project/xlowprrlfuibrmubewlh)

## Docker Command

    After settings up the dockerfile

    ``bash         docker build . -t quanby_lms         docker images         docker run -p 8080:80 quanby_lms     ``

- [X] Dummy Data - Signing of Guests (Teacher/Student) - Integration of the auth (signing and updating profile
- [X] JULY 3, 2023 10:00 am env [setup](https://www.npmjs.com/package/@ngx-env/builder).
- [X] July 10, 2024 Routing by Anton for System Architecture

use this command to make the control flow better in Angular without touching the code, `ng g @angular/core:control-flow` this will make your old code use the convention for the latest angular 17.
